...
const QuoteSection = () => {
  return (
    <div className="flex absolute left-1/2 transform -translate-x-1/2 bg-white w-[78.625rem] h-[17.5rem] top-[115.75rem] justify-center items-center shadow-custom2">
